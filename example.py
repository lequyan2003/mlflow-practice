...
if __name__ == "__main__":
    ...
    csv_url = (
        "https://raw.githubusercontent.com/mlflow/mlflow/master/tests/"
    ...
    with mlflow.start_run():
        ...
        print(
            "Elasticnet model (alpha={:f}, l1_ratio={:f}):".format(
                alpha, l1_ratio
            )
        )
        print("  RMSE: %s" % rmse)
        ...
        # For remote server only (Dagshub)
        # remote_server_uri =
        # "https://dagshub.com/entbappy/MLflow-Basic-Demo.mlflow"
